...
import 'package:m2pcarddetails/m2pcarddetails.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'M2P Card Details'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            CustomText(
              'Click the button to see card details',
            ),
            // Text(
            //   '$_counter',
                ...
                Navigator.of(context).push(
                  CupertinoPageRoute(
                    ...
                    builder: (context) => CardDetailScreen(
                        ...
                        "1115000019",
                        "6d103c6c-44eb-48ad-b35c-15ae2bb97e91",
                        "01011970"),
                  ),
                );
